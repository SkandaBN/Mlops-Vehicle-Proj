    ...
    def __init__(self, database_name: str = DATABASE_NAME) -> None:
        ...
        try:
            ...
            if MongoDBClient.client is None:
                ...
                # Encode special characters in username/password (RFC 3986)
                parsed = urlparse(mongo_db_url)
                if parsed.username or parsed.password:
                    encoded_user = quote_plus(parsed.username) if parsed.username else ""
                    ...
                    mongo_db_url = urlunparse(parsed._replace(netloc=netloc))
